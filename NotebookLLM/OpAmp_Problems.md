...
$$I_D = \mu_n C_{ox} \frac{W}{L} [(V_{GS} - V_{TH})V_{DS} - \frac{1}{2} V_{DS}^2] \tag{1}$$
...
$$g_m = \mu_n C_{ox} \frac{W}{L} V_{DS} \tag{2}$$
...
$$r_o^{-1} = \mu_n C_{ox} \frac{W}{L} [(V_{GS} - V_{TH}) - V_{DS}] \tag{3}$$
$$r_o = \frac{1}{\mu_n C_{ox} \frac{W}{L} (V_{GS} - V_{TH} - V_{DS})}$$
